...
function QuestionWithAnswers(props) {
    ...
    if (q) {
        return (<>
            ...
            {/*                                  vvvvvvvvvvvvvvvvvvvv adding this key={id} we are passing the specific reference to the component. With key we can force the destruction and creation of a new component */}
